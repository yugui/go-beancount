...
// Register adds p to the global plugin registry. It panics if a plugin
// with the same Name() has already been registered. This is intended to
// be called from an init() function; the registry is not safe for
